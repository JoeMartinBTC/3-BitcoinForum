            ...
            <div className="flex gap-2 mt-4">
                  ...
                  <button
                    onClick={() => {
                      import("xlsx").then((XLSX) => {
                        ...
                        const holdingAreaEvents =
                          events?.filter(
                            (event) => event.inHoldingArea === true,
                          ) || [];
                        console.log(
                          "Filtered holding area events:",
                          holdingAreaEvents,
                        );
                        const filteredEvents = holdingAreaEvents.map(
                          (event) => ({
                            ID: event.id,
                            Title: event.title,
                            Description: event.description || "",
              ...
              <input
                ...
                onChange={async (e) => {
                  ...
                  if (file) {
                    ...
                    reader.onload = async (e) => {
                      const password =
                        localStorage.getItem("schedule-password");
                ...
                <AlertDialog>
                  ...
                  <AlertDialogContent>
                    <AlertDialogHeader>
                      ...
                      <AlertDialogDescription>
                        This will remove all events from the schedule. This
              ...
              {(localStorage.getItem("schedule-password") === "99ballons" ||
                ...
                <>
                  <button
                    onClick={() =>
                      document.getElementById("backgroundImport")?.click()
                    }
                    className="px-4 py-2 bg-purple-500 text-white rounded hover:bg-purple-600 transition-colors"
                  >
                    Import Backgrounds
